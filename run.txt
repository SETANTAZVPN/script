...
function LOGO() {
 ...
 ───│    $Green├─┤│ │ │ │ │└─┐│  ├┬┘│├─┘ │   │  │ │ ├┤ $NC   │───
 ───│    $Green┴ ┴└─┘ ┴ └─┘└─┘└─┘┴└─┴┴   ┴   ┴─┘┴ ┴ └─┘$NC   │───
    │    ${YELLOW}Copyright${FONT} (C)$GRAY https://github.com/ariTaz$NC     │
    └───────────────────────────────────────────────┘
...
clear;clear;clear
  ...
  # // Banner
echo -e "${RED}◇━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━◇${NC}"
echo -e "  Welcome To Rizyul Store Script Manager ${BLUE}(${NC}${BLUE} Last Update Edition ${NC}${BLUE})${NC}"
echo -e "     This Will Quick Setup VPN Server On Your Server"
echo -e "         Auther : ${BLUE}Rizyul ${NC}${BLUE}(${NC} ${BLUE} Store Project ${NC}${BLUE})${NC}"
echo -e "       © Recode By Rizyul Store Project ${BLUE}(${NC} 2023 ${BLUE})${NC}"
echo -e "${RED}◇━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━◇${NC}"
echo ""
sleep 3
###### IZIN SC 
...
checking_sc() {
  ...
  if [[ $date_list < $useexp ]]; then
    ...
    echo -e "      \033[0;36mTelegram${NC} t.me/admin"
    echo -e "      ${GREEN}WhatsApp${NC} wa.me/notlpon"
    echo -e "\033[1;93m────────────────────────────────────────────\033[0m"
    exit
  fi
}
...
expx=$(curl https://raw.githubusercontent.com/SETANTAZVPN/izinvps/ipuk/ip | grep $MYIP | awk '{print $3}')
...
Exp1=$(curl https://raw.githubusercontent.com/SETANTAZVPN/izinvps/ipuk/ip | grep $MYIP | awk '{print $4}')
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/SETANTAZVPN/sc/main/"
...
bash -c "$(curl -L https://github.com/XTLS/Xray-install/raw/main/install-release.sh)" @ install -u www-data --version $latest_version
    ...
    curl https://abc.xcodehoster.com/ssh/nginx.conf > /etc/nginx/nginx.conf
...
rm -fr /usr/sbin/menu
rm -fr /usr/local/bin/menu
wget https://raw.githubusercontent.com/SETANTAZVPN/sc/main/menu/menu.zip
unzip menu.zip
    #rm -rf menu.zip
}
...
echo ""
read -n 1 -s -r -p "Press ➥ Enter To Finish Instalasi..."
echo ""
sleep 3
reboot
